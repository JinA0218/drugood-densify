...
if __name__ == '__main__':
    ...
    if os.environ.get("HYPER_SWEEP", "0") == "1":
        datasets = ["nk1", "hivprot", "dpp4"] # "hivprot", "dpp4", 
        ...
        hyper_grid = {
            ...
            "inner_episodes": [10],
            "outer_episodes": [50],
            "n_mvalid": [1, 2], # may include 4 later
            "sencoder_layer" : ["max", "sum", "pma", "mean"] # "sum", "max", "pma", "mean"
        }
        ...
        # else:
        path = f"experiments2/hyper_search_{args.sencoder}_n_mvalid_real_ryv{os.environ.get('RANDOM_YV', '0')}"
        os.makedirs(path, exist_ok=True)
        for arg_key in arg_map.keys():
            ...
            for hyper_key in range(int(os.environ["START"]), int(os.environ["STOP"])):
                ...
                if args.sencoder == "dsets" and args.sencoder_layer == "pma":
                    continue
                ...
                _, _, vmse, tmse = trainer.fit()
                with open(f_path, "wb") as f:
                    pickle.dump({"mse": vmse, "tmse":tmse, **hypers}, f)
    ...
    best_hypers = {
        # 1. set enc all
        # ("hivprot", "count", "dsets"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 2,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 2, 'dropout': 0.5,
        ...
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'dsets', 'n_mvalid': 2, "sencoder_layer": 'mean', 
        # },
        # ("dpp4", "count", "dsets"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 3,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 4, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'dsets', 'n_mvalid': 2, "sencoder_layer": 'sum', 
        # },
        # ("dpp4", "bit", "dsets"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 2,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 2, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'dsets', 'n_mvalid': 2, "sencoder_layer": 'max', 
        # },
        # ("nk1", "count", "dsets"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 3,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 4, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'dsets', 'n_mvalid': 1, "sencoder_layer": 'sum', 
        # },
        # ("nk1", "bit", "dsets"): {
        #     'lr': 0.0001, 'clr': 1e-05, 'num_layers': 2,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 2, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'dsets', 'n_mvalid': 2, "sencoder_layer": 'max', 
        # },
        ...
        ("hivprot", "bit", "dsets"): {
            ...
            'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 1, 'dropout': 0.5,
            'inner_episodes': 10, 'outer_episodes': 50,
            'sencoder': 'dsets', 'n_mvalid': 1, "sencoder_layer": 'mean', 
        },
        ("dpp4", "count", "dsets"): {
            'lr': 0.001, 'clr': 1e-05, 'num_layers': 3,
            'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 4, 'dropout': 0.5,
        ...
        ("nk1", "bit", "dsets"): {
            'lr': 0.0001, 'clr': 1e-05, 'num_layers': 3,
            'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 4, 'dropout': 0.5,
            'inner_episodes': 10, 'outer_episodes': 50,
            'sencoder': 'dsets', 'n_mvalid': 1, "sencoder_layer": 'sum', 
        },
        ...
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 4, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50, 
        #     'sencoder': 'strans', 'n_mvalid': 2, "sencoder_layer": 'sum', 
        # },
        # ("hivprot", "bit", "strans"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 2,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 1, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'strans', 'n_mvalid': 2, "sencoder_layer": 'max', 
        # },
        # ("dpp4", "count", "strans"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 2,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 4, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'strans', 'n_mvalid': 1, "sencoder_layer": 'sum', 
        # },
        # ("dpp4", "bit", "strans"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 3,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 2, 'dropout': 0.5,
        #     'inner_episodes': 10, 'outer_episodes': 50,
        #     'sencoder': 'strans', 'n_mvalid': 1, "sencoder_layer": 'max', 
        # },
        # ("nk1", "count", "strans"): {
        #     'lr': 0.001, 'clr': 1e-05, 'num_layers': 2,
        #     'hidden_dim': 32, 'optimizer': 'adamwschedulefree', 'n_context': 2, 'dropout': 0.5,

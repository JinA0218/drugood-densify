...
if __name__ == '__main__':
    ...
    if os.environ.get("HYPER_SWEEP", "0") == "1":
        ...
        # else:
        path = f"experiments/hyper_search_{args.sencoder}_n_mvalid_real_ryv{os.environ.get('RANDOM_YV', '0')}_mlp_real2"
        os.makedirs(path, exist_ok=True)
    ...
    if not args.same_setting:
        ...
        if not args.mixer_phi:
            with open(f"./experiments/results-{args.sencoder}-MLP_real2.txt", "a+") as _f:

...
if __name__ == '__main__':
    ...
    if os.environ.get("HYPER_SWEEP", "0") == "1":
        ...
        # else:
        path = f"experiments5/hyper_search_{args.sencoder}_n_mvalid_real_ryv{os.environ.get('RANDOM_YV', '0')}"
        os.makedirs(path, exist_ok=True)
    ...
    best_hypers = {
        ### dsets max tuned (lr == 0.001, 'num_layers': 3, hidden_dim=64)
        ("hivprot", "count", "dsets"): {
        ...
        ### set trans sum tuned (lr=0.01, num_layers=3), hd=64

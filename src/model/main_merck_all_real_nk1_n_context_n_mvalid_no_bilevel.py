...
if __name__ == '__main__':
    ...
    if os.environ.get("HYPER_SWEEP", "0") == "1":
        ...
        # else:
        path = f"experiments/hyper_search_{args.sencoder}_n_mvalid_real_ryv{os.environ.get('RANDOM_YV', '0')}_no_bilevel"
        os.makedirs(path, exist_ok=True)
            ...
            if args.context_dataset != None:
                ...
                if os.environ.get('RANDOM_YV', '0') == '0':
                    ...
                    if os.environ.get('MIX_TYPE', 'SET') == 'SET':
                        ...
                        with open(f"./experiments/S-results-{args.sencoder}_mvalid-all-3real-ml{args.mixing_layer}-{os.environ.get('MIXING_X_DEFAULT', 'xmix')}-mvdef{os.environ.get('MVALID_DEFAULT', '1')}-mNct{args.model_no_context}-RYV{os.environ.get('RANDOM_YV', '0')}_{os.environ.get('MIX_TYPE', 'SET')}_real_4.txt", "a+") as _f:
